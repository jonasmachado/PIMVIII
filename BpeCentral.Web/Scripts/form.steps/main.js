$(document).ready(function () {
    ...
    $('#btn-avancar').on('click', function (e) {
        execute_event($('#navigation li.current_nav').index());
    });
        ...
        s.stop().animate({ 'points': svg_valid_icon }, 150, mina.easeout, function () {
            if (btn_index < list_elem_count) {
                ...
                $(".arrow").velocity("fadeOut", {
                    delay: 200, duration: 200, complete: function () {
    ...
    function update_nav_position(el_index, new_pos) {
        ...
        if (el_index <= list_elem_count) {
            $('#btn-avancar').text('Cadastrar');
